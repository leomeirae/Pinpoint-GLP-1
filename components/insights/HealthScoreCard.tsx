...
const styles = StyleSheet.create({
  barContainer: { backgroundColor: '#f0f0f0', borderRadius: 3, flex: 1, height: 6 },
  barFill: { borderRadius: 3, height: '100%' },
  barLabel: { color: '#666', fontSize: 12, width: 80 },
  barValue: { color: '#333', fontSize: 12, fontWeight: '600', textAlign: 'right', width: 30 },
  card: { borderRadius: 16, marginBottom: 16, padding: 20 },
  components: { flex: 1, gap: 12 },
  content: { flexDirection: 'row', gap: 20 },
  header: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 },
  scoreBar: { alignItems: 'center', flexDirection: 'row', gap: 8 },
  ...
  title: { color: '#1a1a1a', fontSize: 18, fontWeight: '600' },
