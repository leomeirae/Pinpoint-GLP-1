# Shotsy: Executive Summary

> "Think Different" para rastreamento de medicação GLP-1
...
**Shotsy** é um app mobile que reimagina como pessoas gerenciam sua jornada com medicação GLP-1 (Mounjaro, Ozempic, Wegovy).

Não somos apenas mais um rastreador. Somos um **companheiro inteligente** que transforma dados de saúde em insights acionáveis, conecta usuários anonimamente, e torna gerenciamento de saúde **envolvente, pessoal e empoderador**.
...
- Falta de comunidade segura e anônima
...
- Personalização que respeita individualidade
- Ferramenta que **celebra progresso**, não apenas monitora

---

## Nossa Solução: "Think Different"
...
4. **Educação Validada**
   - Conteúdo médico certificado
   - IA chatbot especializado
   - Pesquisas científicas curadas

5. **Integração Total**
   - Apple Health / Google Fit
   - Wearables (Watch, Fitbit)
   - Apps de nutrição
...
### Budget Estimado (Fase 1-3)

**Desenvolvimento:** $80K-120K
**Infrastructure:** $2K-5K
**Third-party APIs:** $1K-3K/mês
**Legal/Compliance:** $10K-15K
**Marketing:** $20K-40K

**Total Fase 1-3:** $115K-185K
...
- Design que dá prazer usar

**Nossa missão:**
Transformar a jornada de saúde de intimidadora para empoderadora.

**Nossa visão:**
Tornar Shotsy o app #1 para qualquer pessoa em jornada GLP-1.
